...
<div class="wrap">
    ...
    <form method="post" action="updateResume.bo" enctype="multipart/form-data">
        <div class="contents">
            <div class="contents-top-line">
                <div class="contents-title-line">
                    제목
                    <input id="titleInput" name="title" placeholder="제목을 입력해주세요." value="${r.title}">
                </div>
                <div class="file-line">
                    파일 첨부
                    ...
                    <c:choose>
                        ...
                        <c:otherwise>
                            <span id="fileName">${r.originName}</span>
                        </c:otherwise>
                    </c:choose>
            ...
            <div class="contents-body">
                <div>내용</div>
                <textarea class="contentsInput" name="content" placeholder="내용을 입력하세요.">${r.content}</textarea>
            </div>
            <button type="submit" class="btn-blank-small" id="savebtn">수정하기</button>
        </div>
