...
<div class="container">
    ...
    <form id="enrollForm" method="post" action="update.cl" enctype="multipart/form-data">
        ...
        <table>
            ...
            <tr>
                <th><label for="roomName">강의실</label></th>
                <td><input type="text" id="roomName" name="roomName" value="${b.roomName}" required></td>
            </tr>
            <tr>
